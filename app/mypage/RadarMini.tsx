...
export default function RadarMini({
  ...
  return (
    <svg width="100%" height={size}   viewBox={`${-20} ${-10} ${size + 40} ${size + 20}`}  role="img" aria-label="EVAE Radar">
      {/* グリッド（4リング） */}
      {[1,2,3,4].map(k => (
      ...
      {/* 面 */}
      <polygon points={areaPts} fill={fillColor} stroke={strokeColor} strokeWidth="1.8" />
