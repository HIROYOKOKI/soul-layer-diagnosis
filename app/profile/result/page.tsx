...
type Result = { id: string; name: string; birthday: string; blood: string; gender: string; preference: string; fortune: string; personality: string; ideal_partner: string; created_at: string }
...
<footer className="text-xs opacity-70">保存日時：{new Date(r.created_at).toLocaleString('ja-JP')}</footer>
</div>
)
}
