...
import ClockJST from './ClockJST'// components/layout/MyPageShell.tsx
'use client'

import type { ReactNode } from 'react'
import ThemeRow from './ThemeRow'             // ※ 使わない場合は削除可（lint対象なら残すか後で外す）
import { formatJP } from './date'             // ※ Quick/デイリーの更新時刻で使用
import ClockJST from './ClockJST'             // 同階層に ClockJST.tsx がある前提
...
export default function MyPageShell({ data, children }: MyPageShellProps) {
  ...
  // テーマ名（null/undefined対策 & 表示は常に大文字）
