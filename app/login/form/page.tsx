  ...
  return (
    <main style={page}>
      <section style={card} aria-live="polite">
        ...
        <p style={hint}>
          ※ メール＋パスワードで{mode === 'login' ? 'ログイン' : '登録'}できます。
        </p>
      </section>
...
const tabBtn = {
  flex:1, padding:'8px 10px', borderRadius:9999, border:'1px solid rgba(255,255,255,.15)',
...
const linkBtn = {
  ...
  background:'transparent', border:'none', color:'#9dc9ff',
...
const aura2 = {
  ...
  filter:'blur(16px)', animation:'drift 7s ease-in-out infinite',
}
