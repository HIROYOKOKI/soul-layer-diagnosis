...
export default function ProfileFormClient() {
  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-6 py-8 sm:py-12">
      ...
      <div className="relative rounded-2xl border border-white/10 bg-white/[0.03] p-8 shadow-[0_0_40px_rgba(184,51,245,0.08)] backdrop-blur min-h-[520px]">
        ...
        <form onSubmit={handleSubmit} className="relative grid gap-6">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <Field label="出生地（任意）" icon={<MapPin className="h-4 w-4" />}>
              <input name="birthPlace" type="text" placeholder="Tokyo, JP / Los Angeles, US など" className={inputCls} />
            </Field>
          </div>
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
